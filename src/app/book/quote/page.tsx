          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="mt-8 grid gap-5">
              ...
              <div className="mt-4 grid gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input className="mt-1 w-full px-3 py-2.5 rounded-lg bg-black/40 border border-white/10 focus:border-brand-yellow/60" {...form.register("vehicleMake")} />
                  </div>
                  <div>
                    <label className="text-sm text-white/70">Model</label>
                    <input className="mt-1 w-full px-3 py-2.5 rounded-lg bg-black/40 border border-white/10 focus:border-brand-yellow/60" {...form.register("vehicleModel")} />
                  </div>
                  <div>
                    <label className="text-sm text-white/70">Year</label>
                    <input className="mt-1 w-full px-3 py-2.5 rounded-lg bg-black/40 border border-white/10 focus:border-brand-yellow/60" type="number" {...form.register("vehicleYear")} />
                  </div>
                </div>
              </div>
            </section>
            ...
            {created && (
              <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-sm text-white/70">
                <div className="text-white font-semibold">Request received</div>
                <div className="mt-1">Reference: {created.publicId}</div>
                <div className="mt-3">
                  <a className="inline-flex px-4 py-2 rounded-lg border border-white/15 text-white no-underline hover:bg-white/5" href="/">
                    Back to home
                  </a>
                  <a
                    className="ml-2 inline-flex px-4 py-2 rounded-lg bg-white/10 text-white no-underline hover:bg-white/15"
