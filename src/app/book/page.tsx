    ...
    <div className="container py-12">
      <div className="max-w-3xl">
        ...
        <p className="mt-2 text-white/70">
          Choose the fastest path. Diagnostics are pay-to-confirm. Repairs are quote-first.
        </p>
      </div>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        >
          ...
          <div className="mt-3 text-xs text-white/60">$120 diagnostics + $75 call-out • pay-to-confirm</div>
        </a>
