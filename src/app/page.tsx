      ...
      <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/70">
            Auckland mobile mechanic • Transparent pricing • Fast turnaround
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm text-white/70">
            <div className="rounded-lg border border-white/10 bg-white/5 p-4">
              <div className="text-white font-semibold">Clear pricing</div>
              <div className="mt-1">Diagnostics $120 + call‑out $75.</div>
            </div>
            <div className="rounded-lg border border-white/10 bg-white/5 p-4">
            ...
            <div className="rounded-xl border border-white/10 bg-black/40 p-5">
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-xs text-white/60">+ $75 call‑out</div>
                </div>
              </div>
            </div>
            <div className="rounded-xl border border-white/10 bg-black/40 p-5">
